  ...
  if (total_pages >= 2) {
    ...
    if (total_pages <= 5 && total_pages >= 2) {
      ...
      for (let i = 0; i < total_pages - 1; i++) {
        paginationPlace.innerHTML += `<div value="page" class="pagination__number pagination__button">${
          i + 2
        }</div>`;
      }
    } else {
        ...
        for (let i = initI; i < initI + 6; i++) {
          ...
          if (i == 5 + initI) {
            ...
            if (pageNo < total_pages) {
              switch (pageNo) {
                case 2:
                  paginationPlace.innerHTML += `<div value="page" class="pagination__button">${
                    i - 1
                  }</div>`;
                  break;
                case 1:
...
export const page = (fetchFunc, pageNo = 1, searchVal = '') => {
